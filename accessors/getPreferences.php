...
if(empty($result)){
    echo '<div class="row"><span class="text col-md-2">News: </span><input type="checkbox" class="col-md-1" name="news" id="news" disabled><div class="col-md-9"></div></div>';
    ...
    if($result[0]['news'] == 1)
        echo '<div class="row"><span class="text col-md-2">News: </span><input type="checkbox" class="col-md-1" name="news" id="news" checked disabled><div class="col-md-9"></div></div>';
    else
        echo '<div class="row"><span class="text col-md-2">News: </span><input type="checkbox" class="col-md-1" name="news" id="news" disabled><div class="col-md-9"></div></div>';
    if($result[0]['money'] == 1)
